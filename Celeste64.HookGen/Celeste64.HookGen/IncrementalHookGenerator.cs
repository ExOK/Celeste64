...
public class IncrementalHookGenerator : IIncrementalGenerator
{
	...
	private const string HookGenTargetAttributeNamespace = "Celeste64.Mod";
	private const string HookGenTargetAttributeName = "InternalHookGenTargetAttribute";

	private const string HookGenTargetAttributeCode = $@"// <auto-generated/>

namespace {HookGenTargetAttributeNamespace};

[System.AttributeUsage(System.AttributeTargets.Class)]
public class {HookGenTargetAttributeName} : System.Attribute
{{
	internal string TargetType;
	internal string TargetMemberName;
	internal string[]? TargetParameters;
}}
";
	...
	public void Initialize(IncrementalGeneratorInitializationContext context)
	{
		...
		context.RegisterPostInitializationOutput(ctx => ctx.AddSource(
			$"{HookGenTargetAttributeName}.g.cs",
			SourceText.From(HookGenTargetAttributeCode, Encoding.UTF8)));
		...
		ImmutableArray<ClassDeclarationSyntax> classDeclarations)
	{
		...
		foreach (var classDecl in classDeclarations)
		{
			...
			foreach (var method in methods)
			{
				...
				// Hook attribute
				code.AppendLine(
					$"{Indent}public sealed class {methodName}Attribute : global::{HookGenTargetAttributeNamespace}.{HookGenTargetAttributeName}");
